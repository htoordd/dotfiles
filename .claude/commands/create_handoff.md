...
**IMPORTANT**: Make sure to ultrathink hard as you create the handoff.
...
1. **Check if parameters were provided**:
   - If a ticket id was provided, keep note of it (e.g. `ser-1234`)

2. **If no parameters provided**, respond with:
```
I'll help you create a handoff for another agent.  Please provide a ticket id.
```
...
Use the following information to understand how to create your document:
    - create your file under `<ticket-id>/handoffs/YYYY-MM-DD_HH-MM-SS_description.md`, where:
        ...
        - ticket-id is the user provided ticket id
    - Examples:
        - if the ticket id is `ser-1234`, then create a handoff: `ser-1234/handoffs/2025-10-01_13-55-22_fixing-rendering-issue.md`
...
```bash
/resume_handoff ser-1234/handoffs/2025-01-08_13-44-55_create-context-compaction.md
```
</example_response>
